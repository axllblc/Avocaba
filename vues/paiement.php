  ...
  <body>
    <nav>
      <form action="paiement.php" method="post">
        <input class="nav__btn-retour" type="submit" name="retour" title="Revenir à la page précédente" value='Retour'>
      </form>
    ...
    <main class="paiement">
      ...
      <div class="paiement__main">
        <h2>Paiement</h2>
        <form class="paiement__payer" action="paiement.php?" method="post">
          ...
          <br>
          <label for="no">Numéro de carte</label>
          <input type="text" id="no" name="no" value="" title="La saisie doit contenir uniquement des chiffres et respecter le format : XXXX XXXX XXXX XXXX" placeholder="XXXX XXXX XXXX XXXX" pattern="([0-9]{4}\s){3}[0-9]{4}" required><br>
          <div class="champ">
            <label for="cardExpiration">Date de validité</label>
            <input type="text" id="cardExpiration" name="cardExpiration" value="" size="4" pattern="[0-9]{4}" placeholder="1222" required>
          </div>
          <div class="champ">
          ...
          <input type="submit" name="payer" value="Confirmer ma saisie">
        </form>
      </div>
